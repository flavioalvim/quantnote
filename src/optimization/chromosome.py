...
class Chromosome:
    ...
    def random(cls, search_space: GASearchSpace) -> 'Chromosome':
        ...
        # Random float for slope multiplier
        slope_mult_min, slope_mult_max = search_space.trend_slope_multiplier
        trend_slope_mult = random.uniform(slope_mult_min, slope_mult_max)
        ...
        return cls(
            ...
            trend_slope_multiplier=round(trend_slope_mult, 1),
    ...
    def mutate(
        ...
        return Chromosome(
            ...
            use_trend_indicator=mutate_bool(self.use_trend_indicator)
        )
